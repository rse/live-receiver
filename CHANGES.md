...
- 1.14.3
    - UPDATE: upgrade to Electron 16.0.6
    - UPDATE: upgrade minor dependencies

- 1.14.2
    - UPDATE: upgrade to Electron 16.0.4
    - UPDATE: upgrade minor dependencies
...
- 1.14.0
    ...
    - UPDATE: upgrade to FFmpeg 4.4.1
    - UPDATE: upgrade minor dependencies

- 1.13.3
    - UPDATE: upgrade to Electron 15.3.0
    - UPDATE: upgrade minor dependencies

- 1.13.2
    - UPDATE: upgrade to Electron 15.1.2
    - UPDATE: upgrade minor dependencies
